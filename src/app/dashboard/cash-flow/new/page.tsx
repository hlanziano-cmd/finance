...
import { useCreateCashFlow } from '@/src/lib/hooks/useCashFlow';
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Nuevo Flujo de Caja</h1>
          <p className="mt-1 text-sm text-gray-500">
            Registra tus entradas y salidas de efectivo mensuales
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardContent className="pt-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-900">
                ...
                <p>
                  Ingresa los valores mensuales en la tabla a continuación. Los totales se calcularán automáticamente.
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <Button type="submit" disabled={createMutation.isPending}>
            {createMutation.isPending ? 'Guardando...' : 'Guardar Flujo de Caja'}
          </Button>
        </div>
      </form>
    </div>
